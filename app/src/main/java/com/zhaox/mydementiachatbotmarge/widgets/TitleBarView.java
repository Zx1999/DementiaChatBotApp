package com.zhaox.mydementiachatbotmarge.widgets;
        ...
        for(int i = 0; i < count; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.TitleBarView_leftDrawable:
                    tv_left.setBackgroundResource(array.getResourceId(attr, 0));
                    break;
                case R.styleable.TitleBarView_leftText:
                    tv_left.setText(array.getString(attr));
                    break;
                case R.styleable.TitleBarView_centerTitleColor:
